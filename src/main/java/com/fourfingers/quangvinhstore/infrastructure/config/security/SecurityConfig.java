    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/profile").hasAuthority("CUSTOMER");
                    auth.requestMatchers(HttpMethod.PUT, "/profile").hasAuthority("CUSTOMER");
                    ...
                    auth.requestMatchers(HttpMethod.DELETE, "/admin/**").hasAuthority("ADMINISTRATOR");
                    auth.requestMatchers(HttpMethod.PATCH, "/admin/**").hasAuthority("ADMINISTRATOR");
                    auth.requestMatchers(HttpMethod.GET, "/staff/**").hasAuthority("STAFF");
                    auth.requestMatchers(HttpMethod.POST, "/staff/**").hasAuthority("STAFF");
