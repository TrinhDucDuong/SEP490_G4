        ...
        <section className="bg-white border border-gray-200 rounded-2xl shadow-md p-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row gap-10">
                <div className="flex-1 space-y-5">
                    <Input label="Họ và tên" id="name" value={formData.name} onChange={(e) => handleChange("name", e.target.value)} />
                    <Input label="Email" id="email" value={formData.email} onChange={(e) => handleChange("email", e.target.value)} />
                    <Input label="Số điện thoại" id="phoneNumber" value={formData.phoneNumber} onChange={(e) => handleChange("phoneNumber", e.target.value)} />
                    ...
                    <button
                        type="submit"
                        className="mt-6 bg-black text-white w-full md:w-36 rounded-full py-2 font-semibold hover:bg-gray-900 transition"
                    >
                        Lưu
                    </button>
                </div>
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button
                        ...
                        className="bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-900 transition text-sm"
                    >
                        Chọn ảnh
                    </button>
        ...
        <div>
            ...
            <input
                ...
                className={`w-full border border-gray-300 rounded-lg py-2 px-4 ${
                    readOnly ? "bg-gray-100 text-gray-500" : "bg-white focus:ring-2 focus:ring-black"
                }`}
            />
        </div>
    );
