...
function Payment() {
    ...
    return (
        <div className='max-w-full md:max-w-[900px] lg:max-w-[1400px] mx-auto'>
            ...
            <div className='cart-wrapper flex flex-col md:flex-row gap-8 md:gap-12 p-4 md:p-8 min-h-screen items-stretch'>
                {/* LEFT */}
                <div className='cart-left basis-full md:basis-2/3 bg-white p-6 mb-8 md:mb-0 flex flex-col'>
                    <h2 className='title text-2xl font-bold mb-4 text-black'>Liên Hệ</h2>
                    ...
                    <form className='space-y-4'>
                        ...
                        <div className='map-preview relative w-full h-64 bg-gray-200 rounded-lg mb-2'>
                        ...
                        <div className='payment-methods flex flex-col gap-2'>
                            <div>
                                Chúng tôi cam kết tất cả sản phẩm đều là hàng thật, nguồn gốc rõ ràng.
                                Nói không với hàng giả. hoàn tiền nếu phát hiện sai cam kết.
                            </div>
                            <div>
                                <FontAwesomeIcon
                                    className='mx-2'
